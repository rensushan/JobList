...
class ModelConfig:
    def __init__(self):
        ...
        self.dataset_dir = os.path.join(self.project_dir, 'data', 'SWAG')
        ...
        self.model_save_dir = os.path.join(self.project_dir, 'cache/SWAG')
...
def train(config):
    ...
    logging.info(f"Total time of training = {(end - start):.3f}s")
